  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <NavbarScroll>
        ...
        <nav className="content-container txt-xsmall-plus text-ui-fg-subtle dark:text-ui-fg-muted flex items-center justify-between w-full h-full text-small-regular">
