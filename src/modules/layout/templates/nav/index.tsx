...
export default async function Nav() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <NavbarScroll>
        <header className="relative h-16 mx-auto border-b duration-200 border-ui-border-base dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 backdrop-blur-lg">
